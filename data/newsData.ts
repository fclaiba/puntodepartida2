...
// Helper to get publishDate from article
export const getPublishDate = (article: NewsArticle): string => {
  return article.publishDate || article.date;
};

// Initial news articles with new sections
...
export const getNewsArticles = (): NewsArticle[] => {
  ...
  if (stored) {
    ...
    return articles.filter((a: NewsArticle) => a.section !== 'extrategia');
  }
