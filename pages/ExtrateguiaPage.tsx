...
import { BookOpen, Download, Calendar, ArrowRight, User, Sparkles } from 'lucide-react';
import { useQuery } from "convex/react";
import { api } from "../convex/_generated/api";
import { LoadingSpinner } from "../components/LoadingSpinner";

export const ExtrateguiaPage: React.FC = () => {
  const volumes = useQuery(api.academic.getPublicVolumesWithArticles);
                            ...
                            >
                              ...
                              {article.pdfUrl && (
                                <a href={article.pdfUrl} target="_blank" rel="noopener noreferrer">
                                  <Download
                                    size={20}
                                    className="flex-shrink-0 text-gray-400 group-hover:text-[var(--color-brand-primary)] group-hover:scale-110 transition-all"
                                  />
                                </a>
                              )}
                            </div>
