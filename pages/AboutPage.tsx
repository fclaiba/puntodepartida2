  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <div className="container mx-auto px-5 md:px-10 lg:px-[60px] py-4 md:py-6">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-[var(--color-brand-primary)] transition-colors"
      ...
      <div className="container mx-auto px-5 md:px-10 lg:px-[60px] pb-12 md:pb-16">
        ...
        <div className="max-w-6xl mx-auto mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              <div
                key={index}
                className="p-5 md:p-6 rounded-lg md:rounded-xl text-center bg-[#f9f9f9] dark:bg-gray-900"
              >
                <div
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p
            className="text-gray-700 dark:text-gray-300 mb-8 md:mb-12"
          ...
          <div
            className="p-5 md:p-8 rounded-lg md:rounded-xl bg-[#f9f9f9] dark:bg-gray-900"
          >
            <p
              className="text-gray-800 dark:text-gray-200 mb-4 md:mb-6"
